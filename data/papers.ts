...
export const papers: Paper[] = [
  {
    ...
    abstract: "Households differ not only in the levels of their macroeconomic expectations but also in how those expectations are organized: some move expectations about different outcomes jointly, while others treat each expectation separately. This belief-system structure shapes what any single forecast means, yet forecasts are usually read one at a time. Using 12-wave household panels from the public NY Fed Survey of Consumer Expectations, I show that a core component of this structure is measurable: a validated index ranks households by how tightly their probability expectations move together; the comovement sits far above noise benchmarks and is only partly explained by expectation levels, demographics, or response style. The ranking does not capture optimism or pessimism: in months when a household reports a higher probability that unemployment will rise, it also tends to report a higher probability that stock prices will rise. Inflation expectations sit loosest in the belief system. Under every inflation elicitation the survey offers, the expectation most central to policy communication is the one least connected to households' other macroeconomic beliefs. Structure also matters for interpretation: the mapping from inflation expectations into expected spending is systematically flatter among households whose macro beliefs move most tightly together. A related pattern appears in the ECB Consumer Expectations Survey. Expectations surveys contain a second measurable layer beyond forecast levels, one that central banks monitoring household expectations currently leave unused.",
    links: [
